...
LOGS = logging.getLogger("HOTD العرب \n")
...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/e7b3ea8dc56ac781d756c.mp4", caption="♛ ⦙ تم اعادة تشغيل\n سورس HOTD العرب ✓  :  [ 7.6 ] .\n\nاكتب .اوامري للحصول على الاوامر.\n اكتب .مساعده للحصول على المساعده.",                buttons=[(Button.url("مطور HOTD الرسمي", "https://t.me/jj8jjj8"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين HOTD العرب", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
